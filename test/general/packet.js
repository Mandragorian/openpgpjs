...
-----END PGP PUBLIC KEY BLOCK-----`;
  ...
  it('Public key encrypted symmetric key packet using symmetric keys', () => {
    const serializedPacket = new Uint8Array([
      ...
      0x68, 0xee, 0x1e, 0x00, 0x23, 0x75, 0x8a, 0x90,
      0x85, 0x78, 0x1b, 0xf7, 0xc4, 0x4d, 0x58, 0xc7,
      0x64, 0xd2, 0xe5, 0xb3, 0x4f, 0xf6, 0x6e, 0xef,
      0x53, 0xc4, 0xc3, 0x76, 0x7b, 0xba, 0xf9, 0x03,
      0x86, 0xee, 0xc0, 0x9d, 0x60, 0x23, 0xa6, 0x8a
    ]);
    ...
    expect(packet.publicKeyAlgorithm).to.equal("aead");
